...
function StepCard({ step, index, selected, onToggle }) {
  ...
  return (
    <motion.div
      ...
      className="nova-card overflow-hidden rounded-lg"
    >
      <button
        type="button"
...
export default function PlanCards() {
  ...
  return (
    <motion.aside
      ...
      className="fixed inset-x-3 bottom-28 z-30 max-h-[58vh] overflow-hidden rounded-lg border border-line bg-panel/95 shadow-2xl shadow-black/35 backdrop-blur-2xl xl:static xl:z-auto xl:max-h-none xl:rounded-none xl:border-y-0 xl:border-r-0 xl:bg-panel/70 xl:shadow-none"
    >
          ...
          <div className="flex items-start justify-between gap-3">
            <div>
              <div className="flex items-center gap-2">
                <div className="flex h-9 w-9 items-center justify-center rounded-full bg-brand/15 text-brand ring-1 ring-brand/25">
        ...
        <div className="shrink-0 border-t border-line p-3">
          <div className="grid grid-cols-[1fr_1.45fr] gap-2">
            <button
              ...
              onClick={cancelPlan}
              disabled={isLoading}
              className="flex h-11 items-center justify-center gap-2 rounded-lg border border-line bg-white/[0.04] text-xs font-semibold text-text-soft transition hover:border-danger/30 hover:bg-danger/10 hover:text-danger disabled:opacity-50"
            >
              <XCircle className="h-4 w-4" />
              Cancel
            </button>
            ...
            <motion.button
              ...
              className="flex h-11 items-center justify-center gap-2 rounded-lg bg-brand px-3 text-xs font-bold text-ink-950 shadow-lg shadow-brand/15 transition hover:bg-text disabled:opacity-60"
            >
              {executing ? (
                <>
